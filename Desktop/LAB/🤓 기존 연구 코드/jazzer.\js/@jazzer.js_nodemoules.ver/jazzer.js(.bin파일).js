...
const yargs_1 = __importStar(require("yargs")); //yargs를 사용해 다양한 퍼징 옵션을 정의
...
(0, yargs_1.default)(process.argv.slice(2))
    ...
    //이 밑 부분에서 기본 명령어와 인자를 정의. $0는 스크립트 자체, <>는 필수인자, []는 선택인자
    .command("$0 <fuzz_target> [corpus..]", "Directed, in-process fuzzer for the Node.js platform. \n\n" +
    ...
    yargs
        .positional("fuzz_target", { //퍼징할 타겟 모듈의 이름입니다. 이 모듈은 fuzz 함수를 내보내야 합니다.
        demandOption: true,
        describe: "Name of the module that exports the fuzz target function.",
        type: "string",
    })
        .positional("corpus", { //입력 데이터(corpus)를 저장할 디렉토리 경로입니다. 제공되지 않으면 초기 입력이 없고, 흥미로운 입력도 저장되지 않습니다.
        array: true,
